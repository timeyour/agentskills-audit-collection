...
The full reports live in `validation/`. Structured case briefs: `validation/cases/`. This file highlights the examples that best explain what AgentSkills is trying to prove: AI-built products need evidence, not vibes.
